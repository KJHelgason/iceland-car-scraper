# scrapers/dealerships/bilasolur_seed_links.py
import asyncio
import re
...
async def discover_bilasolur_links() -> List[str]:
    """
    Visit bilasolur.is, iterate the make dropdown options (skipping 'All makes'),
